...
<div class="validation-form" style="margin-bottom: 30px;">
	...
	<div class="row" style="color: white; margin-right: 0; margin-left:0;">
		<div class="col-md-1" style="background-image: linear-gradient(160deg, #010101 0%, #4e6865 100%);">
			<label>ID</label>
		</div>
		<div class="col-md-5" style="background-image: linear-gradient(160deg, #010101 0%, #4e6865 100%);">
			<label>Name</label>
		</div>
		<div class="col-md-2" style="background-image: linear-gradient(160deg, #010101 0%, #4e6865 100%);">
	...
	<?php $i=1; while($row = mysqli_fetch_assoc($viewatten)) { //print_r($row['FullName']);exit();
		$day =$row['TotalDays'];
		$hours =$row['TotalMinute']/60; 
	  $h = str_replace('.',':',round($hours,2));?>
